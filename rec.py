data = {
    ...
    'Series': {
        'The Vampire Diaries': ['Mystery', 'Thriller'],
        'Emily in Paris': ['Romantic', 'Comedy-drama'],
        'Gilmore Girls': ['Comedy-drama', 'Entertainment'],
        'How I Met Your Mother': ['Romance', 'Comedy'],
        'Ginny and Georgia': ['Comedy-drama', 'Romance']
    }
}
